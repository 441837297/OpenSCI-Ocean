...
|---|---|---|---|---|
| DUACS L4 历史（事件库扩展用） | `/mnt/d/p02_data/duacs_hist/duacs_eqpac_<YYYY>.nc` | sla 日均，1993–2022 逐年，5°S–5°N，130°E–80°W，0.125°（MY 数据集 `cmems_obs-sl_glo_phy-ssh_my_allsat-l4-duacs-0.125deg_P1D`，version 202411），约 133 MB/年 | `~/p02/download_duacs_hist.py`（日志 `~/p02/duacs_hist.log`） | 下载中（2026-06-10 启动） |
| ERA5 u10 扩展域（WWB 边界复查用） | `/mnt/d/p02_data/era5/u10_eq_fullyear_130E-180E.nc` | 10m 纬向风日均，2022-12-01–2024-01-15，5°S–5°N，130–180°E，0.25°（ARCO-ERA5 zarr，逐月临时文件在 `monthly_tmp/`） | `~/p02/download_era5_u10.py`（日志 `~/p02/era5_u10.log`） | 下载中（2026-06-10 启动） |
