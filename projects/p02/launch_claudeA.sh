...
## 本项目要点
- 标题：SWOT揭示真实海洋中赤道拓扑波的鲁棒性与失效机制
- 核心问题：理论预言赤道Kelvin/Yanai波受拓扑保护，真实海洋中保护何时有效何时失效？
- 目标期刊：Nature Communications
- 方法框架：SWOT宽刈幅SSH + 物理约束AI模式分解 + 拓扑鲁棒性指标 + Λ控制参数
- 核心数据：SWOT KaRIn SSH + DUACS + TAO/TRITON + Argo + ERA5 + GLORYS12
